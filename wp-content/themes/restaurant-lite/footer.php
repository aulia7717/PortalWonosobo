    	...
    	<div class="container">
             ...
             <div class="cols-4 widget-column-2">            	
               <h5><?php echo get_theme_mod('about_title',__('Our Philosophy','restaurant')); ?></h5>            	
				<p><?php echo get_theme_mod('about_description',__('Visit Wonosobo merupakan salah satu layanan website yang diberikan oleh PT Indonesia Comnets Plus untuk Kabupaten Wonosobo','restaurant')); ?></p>            	
              </div>     
               ...
               <div class="cols-4 widget-column-3">
                  ...
                  <div class="social-icons">
                    ...
                    <?php } else { ?>
                    <?php echo '<a href="https://www.facebook.com/wonosobozone" target="_blank" class="fb" title="facebook"></a>'; } ?>
                    ...
                    <?php } else { ?>
                    <?php echo '<a href="https://www.youtube.com/wonosobozone" target="_blank" class="tw" title="youtube"></a>'; } ?> 
                    ...
                    <?php } else { ?>
                    <?php echo '<a href="https://www.instagram.com/wonosobozone/" target="_blank" class="in" title="instagram"></a>'; } ?>
