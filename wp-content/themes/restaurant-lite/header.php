...
<section id="wrapfirst">
		...
		<section id="wrapsecond">
            	<div class="container">
                    <div class="services-wrap">
                        <h2><?php _e('Populer di Wonosobo','restaurant'); ?></h2>
       ...
       <section id="wrapfirst">
            	<div class="container">
                    <div class="welcomewrap">
                    <center><h2><?php _e('Galeri','restaurant'); ?></h2></center>
                    ...
                    <div class="row">
                        ...
                        <div class="mdb-lightbox no-margin">
                          ...
                          <figure class="col-xs-6 col-sm-4">
                            <a href="https://pbs.twimg.com/media/CHi72g_UwAINt9L.jpg" data-size="300x172">
                              <img alt="picture" src="https://pbs.twimg.com/media/CHi72g_UwAINt9L.jpg" width="304" height="236"
                                class=".img-responsive">
                            </a>
                          </figure>

                          <figure class="col-xs-6 col-sm-4">
                            <a href="http://farm6.staticflickr.com/5605/31328355755_a68907930a_o.jpg" data-size="1600x1067">
                              <img alt="picture" src="http://farm6.staticflickr.com/5605/31328355755_a68907930a_o.jpg" width="304" height="236"
                                class=".img-responsive" />
                            </a>
                          </figure>

                          <figure class="col-xs-6 col-sm-4">
                            <a href="https://bonvoyagejogja.com/wp-content/uploads/2017/06/telaga-warna-dieng-e1496466810777.jpg" data-size="1600x1067">
                              <img alt="picture" src="https://bonvoyagejogja.com/wp-content/uploads/2017/06/telaga-warna-dieng-e1496466810777.jpg" width="304" height="236"
                                class=".img-responsive" />
                            </a>
                          </figure>

                          <figure class="col-xs-6 col-sm-4">
                            <a href="https://carica.co.id/wp-content/uploads/2016/05/carica-dieng-wonosobo.jpg" data-size="300x172">
                              <img alt="picture" src="https://carica.co.id/wp-content/uploads/2016/05/carica-dieng-wonosobo.jpg" width="304" height="236"
                                class=".img-responsive">
                            </a>
                          </figure>

                          <figure class="col-xs-6 col-sm-4">
                            <a href="http://2.bp.blogspot.com/-yWaMxU9wlFA/VTsQIsTNTBI/AAAAAAAAFVA/nkpl3l26tR4/s1600/6%2Bmie%2Bongklok%2B2.JPG" data-size="1600x1067">
                              <img alt="picture" src="http://2.bp.blogspot.com/-yWaMxU9wlFA/VTsQIsTNTBI/AAAAAAAAFVA/nkpl3l26tR4/s1600/6%2Bmie%2Bongklok%2B2.JPG" width="304" height="236"
                                class=".img-responsive" />
                            </a>
                          </figure>

                          <figure class="col-xs-6 col-sm-4">
                            <a href="https://wahyudisite.files.wordpress.com/2013/09/tempe-kemul-2.jpg" data-size="1600x1067">
                              <img alt="picture" src="https://wahyudisite.files.wordpress.com/2013/09/tempe-kemul-2.jpg" width="304" height="236"
                                class=".img-responsive" />
                            </a>
                          </figure>
      ...
      <section id="wrapfirst">
            	<div class="container">
                    <div class="services-wrap">
                        <center><h2><?php _e('Pos Terbaru','restaurant'); ?></h2></center>
